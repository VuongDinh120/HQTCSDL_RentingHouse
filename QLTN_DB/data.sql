...
VALUES (N'Phí trách nhiệm', 1000),(N'Phí thuê', 2000),(N'Phí giới thiệu', 3000)
GO
...
VALUES (1,1,'2021-01-26', '766 Phố Bảo Hương Vy', '7134233872', 1),
		(1,2,'2021-02-18', '971 Phố Thạch Minh Đôn', '8164162290', 1),
		(1,3,'2021-03-09', '20 Phố Cái Du Việt', '8013745927', 0),
		(2,4,'2021-03-14', '72 Phố Chung Thiên Sâm', '5593007349', 0),
		(2,5,'2021-04-19', '144, Thôn Diệu Thập', '4064282444', 1),
		(2,2,'2021-06-24', '971 Phố Thạch Minh Đôn', '8164162290', 1),
		(3,4,'2021-07-09', '72 Phố Chung Thiên Sâm', '5593007349', 0),
		(3,2,'2021-07-11', '971 Phố Thạch Minh Đôn', '8164162290', 1),
		(3,3,'2021-07-14', '20 Phố Cái Du Việt', '8013745927', 0),
		(4,1,'2021-08-20', '766 Phố Bảo Hương Vy', '7134233872', 1),
		(4,5,'2021-11-27', '144, Thôn Diệu Thập', '4064282444', 0),
		(5,3,'2021-12-02', '20 Phố Cái Du Việt', '8013745927', 0),
		(5,4,'2021-12-31', '72 Phố Chung Thiên Sâm', '5593007349', 1)
GO

INSERT INTO surveys(detail, s_status, house_id, s_user_id)
VALUES ('Mái bằng, lợp ngói xám. Hai ống khói nhỏ đặt ở hai bên của ngôi nhà. Cửa sổ giếng trời','Đạt yêu cầu', 1, 1),
		('Tòa nhà có dạng hình tròn. Ngôi nhà được bao quanh hoàn toàn bởi sân', N'Không đạt', 2, 2),
		('Từ bên ngoài ngôi nhà này trông ấm cúng và thoải mái. Nó được xây dựng bằng gỗ sồi','Đạt yêu cầu', 3, 3),
		('Một khu vườn được chăm sóc cẩn thận, với một cánh đồng cỏ và những mảng hoa ở rìa khu vườn','Đạt yêu cầu', 4, 1),
		('Một số cửa sổ lớn mang lại nhiều ánh sáng cho các phòng bên dưới mái nhà','Đạt yêu cầu', 5, 2)
GO
